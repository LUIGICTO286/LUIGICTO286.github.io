...
export const History: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    const sections = gsap.utils.toArray<HTMLDivElement>('.historyline-section');
  ...
  return (
    <div ref={containerRef} className="history-container relative h-screen overflow-hidden border-8 border-blue-500">
      <div ref={scrollWrapperRef} className="history-scroll-wrapper flex h-full w-max">
        {/* First Milestone */}
        <div className="historyline-section min-w-screen flex h-full items-center justify-center bg-gray-100">
          <Historyline
        ...
        {/* Second Milestone */}
        <div className="historyline-section min-w-screen flex h-full items-center justify-center bg-gray-200">
          <Historyline
        ...
        {/* Add more milestones */}
        <div className="historyline-section min-w-screen flex h-full items-center justify-center bg-gray-300">
          <Historyline
            title="A New Dawn"
